...
!   call SIS_error(FATAL, "ITD_LANDFAST can not be true if MERGED_CONTINUITY=True.")
  ...
  if (.not.(do_slab_ice)) then
    ...
    if (CS%merged_cont) then
      ...
      ! call safe_alloc(CS%DS2d%FIA_2d%WindStr_x, G%IsdB, G%IedB, G%jsd, G%jed) ! tjc 4-17-2025
      ...
      call safe_alloc(CS%DS2d%FIA_2d%WindStr_x, G%Isd, G%Ied, G%jsd, G%jed)
      call safe_alloc(CS%DS2d%FIA_2d%WindStr_y, G%isd, G%ied, G%Jsd, G%Jed)
      call safe_alloc(CS%DS2d%FIA_2d%WindStr_ocn_x, G%Isd, G%Ied, G%jsd, G%jed)
      call safe_alloc(CS%DS2d%FIA_2d%WindStr_ocn_y, G%isd, G%ied, G%Jsd, G%Jed)
